    ...
    : describe("Raffle Unit Tests", function () {
          ...
          describe("performUpkeep", function () {
              ...
              it("updates the raffle state and emits a requestId", async () => {
                  ...
                  //indexRequestId property name can change... if this test will not pass, be sure to print out "txReceipt.events[1].args" value to see the new name for indexRequestId
                  //console.log(txReceipt.events[1].args)
                  const requestId = txReceipt.events[1].args.indexRequestId
              ...
              it("picks a winner, resets, and sends money", async () => {
                  ...
                  await new Promise(async (resolve, reject) => {
                      ...
                      await vrfCoordinatorV2Mock.fulfillRandomWords(
                        //indexRequestId property name can change... if this test will not pass, be sure to print out "txReceipt.events[1].args" value to see the new name for indexRequestId
                          txReceipt.events[1].args.indexRequestId,
                          raffle.address
                      )
                  })
              })
